...
def data_loading(data_dir='data/dow30', benchmark='SPY'):
    ...
    df_return = df_adj_close.pct_change() 
    df_return.iloc[0, :] = (df_close.iloc[0, :] / df_open.iloc[0, :]) - 1.0

    return df_open, df_high, df_low, df_close, df_adj_close, df_volume, df_return
